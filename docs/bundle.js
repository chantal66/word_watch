...
const wordCount = __webpack_require__(3);
...
const $ = __webpack_require__(0);
const apiHelper = __webpack_require__(4);
...
const $ = __webpack_require__(0);
const host = __webpack_require__(5).hostUrl;
...
module.exports = {
  hostUrl: 'https://wordwatch-api.herokuapp.com/api/v1'
};
